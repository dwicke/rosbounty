...
class BountyCloudVS:
    ...
    def __init__(self):
        ...
        for server in servers:
            self.taskSendChannels.append(ach.Channel(server.replace(".","") + "VSTaskImg")) # sending on
            self.taskRecvChannels.append(ach.Channel(server.replace(".","") + "VSResp")) # receiving from
